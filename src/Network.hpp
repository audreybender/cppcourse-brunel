...
class Network {
	...
	*/
	...
	FRIEND_TEST(NetworkTest, numberSpikes);      ///<Allow testNeurone to use private attribut
	FRIEND_TEST(NetworkTest, connectionNumber);  ///<Allow testNeurone to use private attribut
